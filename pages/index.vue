<template>
  <div>
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-primary via-primary-dark to-purple-700 text-white py-24 overflow-hidden">
      <div class="absolute inset-0 bg-black/20"></div>
      <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
          <h1 class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
            เทพธิดาแห่งความมืด
          </h1>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button class="border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-primary transition-all">
              🔖 เพิ่มในรายการ
            </button>
          </div>
        </div>
      ...
      <div class="absolute bottom-10 right-10 w-32 h-32 bg-purple-300/20 rounded-full blur-2xl"></div>
      <div class="absolute top-1/2 right-20 w-16 h-16 bg-yellow-300/30 rounded-full blur-lg"></div>
    </section>
    ...
    <ContentWrapper>
      ...
      <SectionWrapper bg-class="bg-white dark:bg-gray-800">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            แพลตฟอร์มอ่านนิยายและการ์ตูนออนไลน์ที่ดีที่สุด<br>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="text-center p-6 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20">
            <div class="w-16 h-16 mx-auto mb-4 bg-blue-500 text-white rounded-full flex items-center justify-center text-2xl">
              📖
            </div>
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">อ่านฟรี</h3>
            <p class="text-gray-600 dark:text-gray-400">เข้าถึงนิยายและการ์ตูนหลากหลายแนวโดยไม่เสียค่าใช้จ่าย</p>
          </div>
          ...
          <div class="text-center p-6 rounded-xl bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/20">
            <div class="w-16 h-16 mx-auto mb-4 bg-green-500 text-white rounded-full flex items-center justify-center text-2xl">
              🔄
            </div>
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">อัปเดตทุกวัน</h3>
            <p class="text-gray-600 dark:text-gray-400">ติดตามเรื่องราวใหม่ๆ ที่อัปเดตสม่ำเสมอทุกวัน</p>
          </div>
          ...
          <div class="text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-violet-100 dark:from-purple-900/20 dark:to-violet-900/20">
            <div class="w-16 h-16 mx-auto mb-4 bg-purple-500 text-white rounded-full flex items-center justify-center text-2xl">
              👁️
            </div>
            <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2">ถนอมสายตา</h3>
            <p class="text-gray-600 dark:text-gray-400">ปรับแต่งการอ่านให้เหมาะกับสายตาด้วยระบบที่ทันสมัย</p>
          </div>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper bg-class="bg-gray-50 dark:bg-gray-900">
        <h2 class="text-3xl font-bold text-gray-800 dark:text-white mb-10 text-center">
          หมวดหมู่ยอดนิยม
        </h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          ...
          >
            <div class="w-20 h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-300 shadow-lg">
              {{ category.emoji }}
            </div>
      ...
      <SectionWrapper bg-class="bg-primary text-white" py="py-12">
        <div class="text-center">
          ...
          <div class="flex justify-center gap-6">
            <a href="#" class="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-lg transition-colors">
              📘 Facebook
            </a>
            <a href="#" class="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-lg transition-colors">
              💬 Line
...
const popularNovels = [
  ...
  },
  {
    ...
    views: '201K',
    slug: 'queen-of-death',
    cover: 'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=250&h=350&fit=crop'
  },
  {
    id: 11,
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'แพลตฟอร์มอ่านมังงะและนิยายออนไลน์ที่ดีที่สุด พร้อมเนื้อหาคุณภาพสูงและการอัปเดตทุกวัน' }
  ]
})
</script>
