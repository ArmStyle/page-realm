    ...
    <div class="container mx-auto px-4 py-8">
      <div class="grid lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1 hidden lg:block">
          <WriteSidebar 
            :stats="novelsStore.stats"
            stats-title="สถิตินิยาย"
          />
        </div>
        ...
        <div class="lg:col-span-3">
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
              <div class="stats-card bg-gradient-to-r from-purple-100 to-indigo-100 p-6 rounded-xl">
                <div class="flex items-center justify-between">
                  <div>
                    <h3 class="text-lg font-semibold text-gray-700">ผลงานนิยายทั้งหมด</h3>
                    <p class="text-3xl font-bold text-purple-600 mt-2">{{ novelsStore.stats.totalWorks }}</p>
              ...
              <div class="stats-card bg-gradient-to-r from-blue-100 to-cyan-100 p-6 rounded-xl">
                <div class="flex items-center justify-between">
                  <div>
                    <h3 class="text-lg font-semibold text-gray-700">คนกำลังติดตาม</h3>
                    <p class="text-3xl font-bold text-blue-600 mt-2">{{ novelsStore.stats.totalFavorites }}</p>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div v-else-if="novelsStore.error" class="text-center py-12">
              ...
              <p class="text-gray-600 mb-4">{{ novelsStore.error }}</p>
              <button 
            ...
            <div v-else class="text-center py-12">
              <div class="w-32 h-32 mx-auto mb-6 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-full flex items-center justify-center">
                <span class="text-6xl">📖</span>
              </div>
              <h3 class="text-2xl font-bold text-gray-700 mb-4">ยังไม่มีผลงานนิยาย</h3>
