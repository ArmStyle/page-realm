    ...
    <div class="w-full max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 overflow-x-auto">
      ...
      <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-6 w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 w-full">
          <div
            class="stats-card bg-gradient-to-r from-orange-100 to-pink-100 p-4 sm:p-6 rounded-xl min-w-0"
          >
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-orange-600 mt-2 break-words">
          ...
          <div
            class="stats-card bg-gradient-to-r from-blue-100 to-purple-100 p-4 sm:p-6 rounded-xl min-w-0"
          >
            <div class="flex items-center justify-between">
              <div>
                <h3 class="text-lg font-semibold text-gray-700">
      ...
      <div class="bg-white rounded-xl shadow-sm p-4 sm:p-6 w-full overflow-x-auto">
        ...
        <div v-else-if="worksStore.error" class="text-center py-12">
          ...
          <p class="text-gray-600 mb-4 break-words">{{ worksStore.error }}</p>
          <button
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-wrap gap-1 mb-2">
                      <span
                        ...
                        :key="tag"
                        class="bg-orange-100 text-orange-600 px-2 py-1 rounded text-xs truncate"
                      >
                        {{ tag }}
                      </span>
                      <span
        ...
        <div v-else class="text-center py-12">
          <div
            class="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-6 bg-gradient-to-r from-orange-100 to-pink-100 rounded-full flex items-center justify-center"
          >
