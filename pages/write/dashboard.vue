      ...
      <div class="grid lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">รายงานสถิติ</h2>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-6">
              <div class="stats-card bg-gradient-to-r from-orange-100 to-pink-100 p-6 rounded-xl">
                <div class="flex items-center justify-between">
                  <div>
                    <h3 class="text-lg font-semibold text-gray-700">ผลงานทั้งหมด</h3>
                    <p class="text-3xl font-bold text-orange-600 mt-2">{{ totalWorks }}</p>
              ...
              <div class="stats-card bg-gradient-to-r from-blue-100 to-purple-100 p-6 rounded-xl">
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600 mt-2">{{ totalViews.toLocaleString() }}</p>
              ...
              <div class="stats-card bg-gradient-to-r from-green-100 to-teal-100 p-6 rounded-xl">
                <div class="flex items-center justify-between">
                  <div>
                    <h3 class="text-lg font-semibold text-gray-700">ผู้ติดตามรวม</h3>
                    <p class="text-3xl font-bold text-green-600 mt-2">{{ totalFollowers.toLocaleString() }}</p>
          ...
          <div class="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
              ...
              <div class="space-y-3">
                <div v-for="work in popularWorks" :key="work.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div class="flex items-center space-x-3">
                    <div class="w-8 h-8 bg-orange-200 rounded text-center leading-8 text-sm font-bold">{{ work.rank }}</div>
                    <div>
                  ...
                  <div class="text-right">
                    <p class="font-semibold text-gray-800">{{ work.views.toLocaleString() }}</p>
...
const recentActivities = ref([
  { id: 1, message: "อัปเดตตอนใหม่ของ 'เรื่องราวแห่งดวงดาว'", date: new Date() },
  { id: 2, message: "ได้รับความคิดเห็นใหม่ 15 ความคิดเห็น", date: new Date(Date.now() - 2 * 60 * 60 * 1000) },
  { id: 3, message: "ผู้ติดตามใหม่ 8 คน", date: new Date(Date.now() - 5 * 60 * 60 * 1000) },
  { id: 4, message: "ผลงาน 'การผจญภัยของฮีโร่' ถูกแชร์ 12 ครั้ง", date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000) }
])
