<template>
  <div class="tag-input">
    ...
    <div class="relative">
      <div
        class="flex flex-wrap gap-2 p-3 border border-gray-300 dark:border-gray-600 rounded-md min-h-[42px] bg-white dark:bg-gray-800 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 dark:focus-within:border-blue-400"
      >
        <span
        ...
        >
          ...
          <button
            ...
            class="hover:bg-blue-200 dark:hover:bg-primary-dark rounded-full p-0.5"
          >
        ...
        <input
          ...
          class="flex-1 min-w-[120px] border-none outline-none bg-transparent disabled:cursor-not-allowed text-gray-900 dark:text-gray-100"
        />
      </div>
      ...
      >
        ...
        <span v-if="inputValue"
          >{{ inputValue.length }}/{{ maxTagLength }} ตัวอักษร</span
        >
      </div>
    </div>
    ...
    <p v-if="help" class="mt-1 text-sm" style="color: var(--color-label)">
      {{ help }}
    </p>
  </div>
</template>
