<template>
  ...
  >
    ...
    <!-- Left Icon -->
    <component v-else-if="leftIcon" :is="leftIcon" class="w-5 h-5" />
    ...
    <!-- Right Icon -->
    <component v-if="rightIcon && !loading" :is="rightIcon" class="w-5 h-5" />
...
const buttonClasses = computed(() => {
  ...
  const variantClasses = {
    primary: [
      "bg-primary text-white dark:bg-primary-light eyecare:bg-amber-600 eyecare:text-white  ",
      "hover:bg-primary-dark dark:hover:bg-primary eyecare:hover:bg-amber-700 -400 hover:shadow-lg hover:-translate-y-0.5",
      "focus:ring-primary/50 dark:focus:ring-primary-light/50 eyecare:focus:ring-amber-600/50 -500/50",
      "active:transform active:scale-95",
    ],
    secondary: [
      "bg-gray-500 dark:bg-gray-600 eyecare:bg-amber-500  text-white",
      "hover:bg-gray-600 dark:hover:bg-gray-500 eyecare:hover:bg-amber-600 -500 hover:shadow-lg hover:-translate-y-0.5",
      "focus:ring-gray-500/50 dark:focus:ring-gray-600/50 eyecare:focus:ring-amber-500/50 -600/50",
      "active:transform active:scale-95",
    ],
    success: [
